...
$ACTION="sheet_equipment_outline_list.php";

require('./disp_parts/headerNonjs.php');
    ...
    <td>
      <table width="100%">
        <tr>
          ...
          <td width="15%">
            <?php _inputv2("〒", "郵便番号",  $郵便番号, "text", "edit", ""); ?>
          </td>
          <td width="75%">
          </td>
        </tr>
        ...
        <tr>
          ...
          <td colspan="2">
            <?php _inputv2("", "所在地",  $所在地, "text", "edit", ""); ?>
          </td>
        </tr>
      ...
      <table width="100%">
        <tr>
          <td width="15%">
            <?php _inputv2("TEL", "電話",  $電話番号, "text", "edit", ""); ?>
          </td>
          <td width="15%">
            <?php _inputv2("FAX", "FAX",  $FAX番号, "text", "edit", ""); ?>
          </td>
          <td width="35%">
            <?php _inputv2("MAIL", "MAIL",  $MAIL, "text", "edit", ""); ?>
          </td>
          <td width="35%">
            <?php _inputv2("URL", "URL",  $URL, "text", "edit", ""); ?>
          </td>
        </tr>
      </table>
...
<table class="table tunagi table-bordered border-secondary table_tunagi">
  <tr>
    <td width="30%">
      <p>施設長氏名</p>
      <?php _inputv2("", "施設長",  $管理者, "text", "edit", ""); ?>
    </td>
    <td>
      <p>実習指導者氏名</p>
      ...
      <table width="100%">
        <tr>
          <td width="33%">
            <?php _inputv2("", "指導者1",  $実習指導者1, "text", "edit", ""); ?>
          </td>
          <td width="33%">
            <?php _inputv2("", "指導者2",  $実習指導者2, "text", "edit", ""); ?>
          </td>
          <td width="33%">
            <?php _inputv2("", "指導者3",  $実習指導者3, "text", "edit", ""); ?>
          </td>
        </tr>
      </table>
    </td>
...
<table class="table tunagi table-bordered border-secondary table_tunagi">
  <tr>
    ...
    <td width="30%">
      <p>実習種別</p>
      <?php _inputv2("", "実習種別",  $実習種別, "text", "edit", ""); ?>
    </td>
      ...
      <table width="100%">
        <tr>
          <td class="text-end">
               ...
               <!--_inputv2("", "実習開始日",  date('Y年m月d日', strtotime($実習開始日)) , "text", "edit", ""); ?>-->
          </td>
          ...
          <td>
                  ...
                  <!-- _inputv2("", "実習終了日",  date('Y年m月d日', strtotime($実習終了日)) , "text", "edit", ""); -->
          </td>
        </tr>
      </table>
  ...
  <tr height="290px">
    <td>
      <table style="width:100%;">
        ...
        <tr>
          <td>
            <?php _inputv2("", "法人事業概要",  $法人事業概要, "textarea", "edit", "h200"); ?>
          </td>
        </tr>
      </table>
    </td>
  ...
  <tr height="240px">
    <td>
      <table style="width:100%;">
        ...
        <tr>
          <td>
            <?php _inputv2("", "施設事業概要",  $施設事業概要, "textarea", "edit", "h200"); ?>
      ...
      <table style="width:100%;">
        ...
        <tr>
          <td style="height:800px">
            <?php _inputv2("", "周辺地域",  $周辺地域, "textarea", "edit", "h100p"); ?>
        </tr>
    ...
    <td>
      <table>
        <tr>
          ...
          <td>
            <?php _inputv2("", "氏名",   $_SESSION['NAME'], "text", "", ""); ?>
          </td>
          <td>
...
<input type='hidden' name='TABLE' value="tbl_institution_overview">
